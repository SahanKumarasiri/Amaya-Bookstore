...
export default class Item extends React.Component {
  ...
  getData = () => {
    fetch(`http://localhost:8070/adventure`)
    ...
    return (
        <div id="header">
            ...
            <div style={{marginLeft:"15px"}}>
                <Link to="/"><span>Dashbord</span ></Link> <i class="fa fa-chevron-right" aria-hidden="true"></i> <Link to="/adventure"><span>අභිරහස් කතා - Adventure Books</span ></Link>
            </div>
            ...
            <hr class="my-4"></hr>
            <center><h1 style={{fontFamily:"Copperplate, Papyrus, fantasy"}}>අභිරහස් කතා - Adventure Books</h1></center>
            <hr class="my-4"></hr>
                ...
                <nav className="nav">
                    <ul className="ul">
                        ...
                        <li className="li"><Link to="/">Home</Link></li>
                            ...
                            <li className="li"><Link className="active" to="/adventure">අභිරහස් කතා - Adventure Stories</Link></li>
