  ...
  handleInputChange = event => {
    ...
    this.setState(prevState => {
      const filteredData = prevState.data.filter(element => {
        return element.bookName.toLowerCase().includes(query.toLowerCase());
      });
    ...
    return (
        <div id="header">
            ...
            <div style={{marginLeft:"15px"}}>
                <Link to="/"><span>Dashbord</span ></Link> <i class="fa fa-chevron-right" aria-hidden="true"></i> <Link to="/novel"><span>නවකතා - Novels</span ></Link>
            </div>
            ...
            <hr class="my-4"></hr>
            <center><h1 style={{fontFamily:"Copperplate, Papyrus, fantasy"}}>නවකතා - Novels</h1></center>
            <hr class="my-4"></hr>
                ...
                <nav className="nav">
                    <ul className="ul">
                        ...
                        <li className="li"><Link to="/">Home</Link></li>
                            <li className="li"><Link class="active" to="/novel">නවකතා - Novels</Link></li>
                                ...
                                <div style={{display:"inline-block" , padding: "10px 1px 10px 10px"}}>
                                    <center>
                                        <div className="card border-primary mb-3" > 
                                            ...
                                            <Link to= {`/view/${i._id}/${crypto.randomBytes(40).toString("hex")}/${i.bookName}/${i.author}/${encodeURIComponent(i.bookURL)}/${encodeURIComponent(i.bookImage)}/${i.downloads}/${i.hearts}/${i.category}/${"නවකතා - Novels"}/${encodeURIComponent("/novel")}`}><button className="btn btn-primary" style={{width:"100%"}}><i class="fa fa-eye" aria-hidden="true"></i> View</button></Link>
                                            </div>
