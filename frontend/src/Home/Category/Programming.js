    ...
    return (
        <div id="header">
            ...
            <div style={{marginLeft:"15px"}}>
                <Link to="/"><span>Dashbord</span ></Link> <i class="fa fa-chevron-right" aria-hidden="true"></i> <Link to="/programming"><span>Programming Books</span ></Link>
            </div>
            ...
            <hr class="my-4"></hr>
            <center><h1 style={{fontFamily:"Copperplate, Papyrus, fantasy"}}>Programming Books</h1></center>
            <hr class="my-4"></hr>
            ...
            <section>
                ...
                <article>
                    <div class="input-group rounded">
                      ...
                      <span class="input-group-text border-0" id="search-addon" onClick={this.Search} style = {{float:"right"}}>
