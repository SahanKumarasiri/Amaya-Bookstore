...
export default class ProgrammingRow extends Component {
    ...
    deleteCustomer() {
        axios.delete('http://localhost:8070/programming/delete/' + this.props.obj._id)
            .then((res) => {
                toast("Success! Programming Deleted 😘")
                alert("Deleted")
            }).catch((error) => {
                console.log(error)
            })
